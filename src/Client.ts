...
export class StripeClient {
     ...
     * @param {Stripe.GetAccountsAccountRequest} request
     * @param {StripeClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.getAccountsAccount("account")
     */
    public async getAccountsAccount(
        account: string,
        request: Stripe.GetAccountsAccountRequest = {},
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/accounts/{account}.");
            case "unknown":
                throw new errors.StripeError({
     ...
     * @param {string} id
     * @param {Stripe.PostCustomersCustomerSourcesIdRequest} request
     * @param {StripeClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.postCustomersCustomerSourcesId("customer", "id")
     */
    public async postCustomersCustomerSourcesId(
        customer: string,
        id: string,
        request: Stripe.PostCustomersCustomerSourcesIdRequest = {},
        requestOptions?: StripeClient.RequestOptions,
        ...
        if (_response.ok) {
            return _response.body as Stripe.PostCustomersCustomerSourcesIdResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling POST /v1/customers/{customer}/sources/{id}.",
                );
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {Stripe.GetTaxIdsRequest} request
     * @param {StripeClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.getTaxIds()
     */
    public async getTaxIds(
        request: Stripe.GetTaxIdsRequest = {},
        requestOptions?: StripeClient.RequestOptions,
        ...
        if (_response.ok) {
            return _response.body as Stripe.GetTaxIdsResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/tax_ids.");
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {Stripe.PostTaxIdsRequest} request
     * @param {StripeClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.postTaxIds({
     *         type: "ad_nrt",
     *         value: "value"
     *     })
     */
    public async postTaxIds(
        request: Stripe.PostTaxIdsRequest,
        requestOptions?: StripeClient.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling POST /v1/tax_ids.");
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} id
     * @param {Stripe.GetTaxIdsIdRequest} request
     * @param {StripeClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.getTaxIdsId("id")
     */
    public async getTaxIdsId(
        id: string,
        request: Stripe.GetTaxIdsIdRequest = {},
        requestOptions?: StripeClient.RequestOptions,
    ): Promise<Stripe.TaxId> {
        const { expand } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/tax_ids/{id}.");
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
                });
     ...
     *
     * @param {string} id
     * @param {Stripe.DeleteTaxIdsIdRequest} request
     * @param {StripeClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.deleteTaxIdsId("id")
     */
    public async deleteTaxIdsId(
        id: string,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling DELETE /v1/tax_ids/{id}.");
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
                });
