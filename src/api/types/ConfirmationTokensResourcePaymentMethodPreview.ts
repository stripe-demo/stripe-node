...
export interface ConfirmationTokensResourcePaymentMethodPreview {
    ...
    allow_redisplay?: ConfirmationTokensResourcePaymentMethodPreview.AllowRedisplay;
    ...
    customer?: ConfirmationTokensResourcePaymentMethodPreview.Customer;
    ...
    type: ConfirmationTokensResourcePaymentMethodPreview.Type;
    us_bank_account?: Stripe.PaymentMethodUsBankAccount;
    wechat_pay?: Stripe.PaymentMethodWechatPay;
    zip?: Stripe.PaymentMethodZip;
}

export namespace ConfirmationTokensResourcePaymentMethodPreview {
    /**
     * This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
     */
