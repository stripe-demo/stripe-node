 ...
 *     {}
 */
export interface InvoiceUpcomingRequest {
    /**
     ...
     */
    discounts?: Stripe.InvoiceUpcomingRequestDiscounts;
    /**
     ...
     */
    invoice_items?: Stripe.InvoiceUpcomingRequestInvoiceItemsItem | Stripe.InvoiceUpcomingRequestInvoiceItemsItem[];
    /**
     * The account (if any) for which the funds of the invoice payment are intended. If set, the invoice will be presented with the branding and support information of the specified account. See the [Invoices with Connect](https://stripe.com/docs/billing/invoices/connect) documentation for details.
     */
    on_behalf_of?: Stripe.InvoiceUpcomingRequestOnBehalfOf;
    /**
     * Customizes the types of values to include when calculating the invoice. Defaults to `next` if unspecified.
     */
    preview_mode?: Stripe.InvoiceUpcomingRequestPreviewMode;
    /**
     ...
     */
    subscription_billing_cycle_anchor?: Stripe.InvoiceUpcomingRequestSubscriptionBillingCycleAnchor;
    /**
     * A timestamp at which the subscription should cancel. If set to a date before the current period ends, this will cause a proration if prorations have been enabled using `proration_behavior`. If set during a future period, this will always cause a proration for that period. This field has been deprecated and will be removed in a future API version. Use `subscription_details.cancel_at` instead.
     */
    subscription_cancel_at?: Stripe.InvoiceUpcomingRequestSubscriptionCancelAt;
    /**
     ...
     */
    subscription_default_tax_rates?: Stripe.InvoiceUpcomingRequestSubscriptionDefaultTaxRates;
    /**
     ...
     */
    subscription_items?:
        | Stripe.InvoiceUpcomingRequestSubscriptionItemsItem
        | Stripe.InvoiceUpcomingRequestSubscriptionItemsItem[];
    /**
     * Determines how to handle [prorations](https://stripe.com/docs/billing/subscriptions/prorations) when the billing cycle changes (e.g., when switching plans, resetting `billing_cycle_anchor=now`, or starting a trial), or if an item's `quantity` changes. The default value is `create_prorations`. This field has been deprecated and will be removed in a future API version. Use `subscription_details.proration_behavior` instead.
     */
    subscription_proration_behavior?: Stripe.InvoiceUpcomingRequestSubscriptionProrationBehavior;
    /**
     ...
     */
    subscription_trial_end?: Stripe.InvoiceUpcomingRequestSubscriptionTrialEnd;
    /**
