 ...
 *     }
 */
export interface TransactionCreateForceCaptureRequest {
    ...
    merchant_data?: TransactionCreateForceCaptureRequest.MerchantData;
    /** Additional purchase information that is optionally provided by the merchant. */
    purchase_details?: TransactionCreateForceCaptureRequest.PurchaseDetails;
}

export namespace TransactionCreateForceCaptureRequest {
    /**
     * Details about the seller (grocery store, e-commerce website, etc.) where the card authorization happened.
     */
