 ...
 *     }
 */
export interface TransactionCreateUnlinkedRefundRequest {
    ...
    merchant_data?: TransactionCreateUnlinkedRefundRequest.MerchantData;
    /** Additional purchase information that is optionally provided by the merchant. */
    purchase_details?: TransactionCreateUnlinkedRefundRequest.PurchaseDetails;
}

export namespace TransactionCreateUnlinkedRefundRequest {
    /**
     * Details about the seller (grocery store, e-commerce website, etc.) where the card authorization happened.
     */
