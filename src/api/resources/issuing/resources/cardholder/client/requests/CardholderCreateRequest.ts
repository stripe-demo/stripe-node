 ...
 *     }
 */
export interface CardholderCreateRequest {
    /** The cardholder's billing address. */
    billing: CardholderCreateRequest.Billing;
    /** Additional information about a `company` cardholder. */
    company?: CardholderCreateRequest.Company;
    /** The cardholder's email address. */
    email?: string;
    /** Specifies which fields in the response should be expanded. */
    expand?: string[];
    /** Additional information about an `individual` cardholder. */
    individual?: CardholderCreateRequest.Individual;
     ...
     */
    preferred_locales?: CardholderCreateRequest.PreferredLocales.Item[];
    /** Rules that control spending across this cardholder's cards. Refer to our [documentation](https://stripe.com/docs/issuing/controls/spending-controls) for more details. */
    spending_controls?: CardholderCreateRequest.SpendingControls;
    /** Specifies whether to permit authorizations on this cardholder's cards. Defaults to `active`. */
    status?: CardholderCreateRequest.Status;
    /** One of `individual` or `company`. See [Choose a cardholder type](https://stripe.com/docs/issuing/other/choose-cardholder) for more details. */
    type?: CardholderCreateRequest.Type;
}

export namespace CardholderCreateRequest {
    /**
     * The cardholder's billing address.
     */
    ...
    export namespace Individual {
        ...
        export namespace CardIssuing {
            ...
            export interface UserTermsAcceptance {
                ...
                user_agent?: UserTermsAcceptance.UserAgent;
            }

            export namespace UserTermsAcceptance {
                /**
                 * The user agent of the browser from which the cardholder accepted the Authorized User Terms.
                 */
    ...
    export interface SpendingControls {
        ...
        allowed_categories?: SpendingControls.AllowedCategories.Item[];
        ...
        blocked_categories?: SpendingControls.BlockedCategories.Item[];
        /** Array of strings containing representing countries from which authorizations will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `allowed_merchant_countries`. Provide an empty value to unset this control. */
        blocked_merchant_countries?: string[];
        /** Limit spending with amount-based rules that apply across this cardholder's cards. */
        spending_limits?: SpendingControls.SpendingLimits.Item[];
    ...
    export namespace SpendingControls {
        ...
        export type SpendingLimits = SpendingLimits.Item[];

        export namespace SpendingLimits {
            ...
            export namespace Item {
                 ...
                 * Interval (or event) to which the amount applies.
                 */
                export type Interval = "all_time" | "daily" | "monthly" | "per_authorization" | "weekly" | "yearly";
