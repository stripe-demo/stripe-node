...
export class Mandate {
    constructor(protected readonly _options: Mandate.Options) {}

    /**
     * <p>Retrieves a Mandate object.</p>
     *
     * @param {string} mandate
     * @param {Stripe.MandateRetrieveRequest} request
     * @param {Mandate.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async retrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `v1/mandates/${encodeURIComponent(mandate)}`,
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return _response.body as Stripe.Mandate;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/mandates/{mandate}.");
            case "unknown":
                throw new errors.StripeError({
