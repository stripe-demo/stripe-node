...
export class Supplier {
    constructor(protected readonly _options: Supplier.Options) {}

    /**
     * <p>Lists all available Climate supplier objects.</p>
     *
     * @param {Stripe.climate.SupplierListRequest} request
     * @param {Supplier.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async list(
    ...
    ): Promise<Stripe.climate.SupplierListResponse> {
        ...
        if (_response.ok) {
            return _response.body as Stripe.climate.SupplierListResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/climate/suppliers.");
            case "unknown":
                throw new errors.StripeError({
     ...
     * @param {Stripe.climate.SupplierRetrieveRequest} request
     * @param {Supplier.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async retrieve(
        ...
        requestOptions?: Supplier.RequestOptions,
    ): Promise<Stripe.ClimateSupplier> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.StripeEnvironment.Default,
                `v1/climate/suppliers/${encodeURIComponent(supplier)}`,
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return _response.body as Stripe.ClimateSupplier;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling GET /v1/climate/suppliers/{supplier}.",
                );
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
