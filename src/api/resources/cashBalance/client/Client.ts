...
export class CashBalance {
    constructor(protected readonly _options: CashBalance.Options) {}

    /**
     * <p>Retrieves a customer’s cash balance.</p>
     *
     * @param {string} customer
     * @param {Stripe.CashBalanceRetrieveRequest} request
     * @param {CashBalance.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async retrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `v1/customers/${encodeURIComponent(customer)}/cash_balance`,
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return _response.body as Stripe.CashBalance;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling GET /v1/customers/{customer}/cash_balance.",
                );
            case "unknown":
                throw new errors.StripeError({
     ...
     *
     * @param {string} customer
     * @param {Stripe.CashBalanceUpdateRequest} request
     * @param {CashBalance.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async update(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling POST /v1/customers/{customer}/cash_balance.",
                );
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
