...
export class Session {
     ...
     *
     * @param {Stripe.billingPortal.SessionCreateRequest} request
    ...
    public async create(
    ...
    ): Promise<Stripe.BillingPortalSession> {
        ...
        if (_response.ok) {
            return _response.body as Stripe.BillingPortalSession;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling POST /v1/billing_portal/sessions.");
            case "unknown":
                throw new errors.StripeError({
