...
export class Event {
     ...
     *
     * @param {Stripe.EventListRequest} request
     * @param {Event.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async list(
    ...
    ): Promise<Stripe.EventListResponse> {
        const {
        ...
        if (deliverySuccess != null) {
            _queryParams["delivery_success"] = deliverySuccess.toString();
        }
        ...
        if (_response.ok) {
            return _response.body as Stripe.EventListResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/events.");
            case "unknown":
                throw new errors.StripeError({
     ...
     *
     * @param {string} id
     * @param {Stripe.EventRetrieveRequest} request
     * @param {Event.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async retrieve(
        ...
        if (_response.ok) {
            return _response.body as Stripe.Event;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/events/{id}.");
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
                });
