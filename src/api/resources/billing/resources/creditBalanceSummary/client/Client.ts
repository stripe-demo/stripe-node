...
export class CreditBalanceSummary {
    constructor(protected readonly _options: CreditBalanceSummary.Options) {}

    /**
     * <p>Retrieves the credit balance summary for a customer.</p>
     *
     * @param {Stripe.billing.CreditBalanceSummaryRetrieveRequest} request
     * @param {CreditBalanceSummary.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async retrieve(
    ...
    ): Promise<Stripe.BillingCreditBalanceSummary> {
        const { customer, expand, filter } = request;
        ...
        if (_response.ok) {
            return _response.body as Stripe.BillingCreditBalanceSummary;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling GET /v1/billing/credit_balance_summary.",
                );
            case "unknown":
                throw new errors.StripeError({
