...
export class LineItem {
     ...
     * @param {Stripe.LineItemListRequest} request
    ...
    public async list(
    ...
    ): Promise<Stripe.LineItemListResponse> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `v1/invoices/${encodeURIComponent(invoice)}/lines`,
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return _response.body as Stripe.LineItemListResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/invoices/{invoice}/lines.");
            case "unknown":
                throw new errors.StripeError({
     ...
     *
     * @param {string} invoice - Invoice ID of line item
     * @param {string} lineItemId - Invoice line item ID
     * @param {Stripe.LineItemUpdateRequest} request
     * @param {LineItem.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async update(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.StripeEnvironment.Default,
                `v1/invoices/${encodeURIComponent(invoice)}/lines/${encodeURIComponent(lineItemId)}`,
            ),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return _response.body as Stripe.LineItem;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling POST /v1/invoices/{invoice}/lines/{line_item_id}.",
                );
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
