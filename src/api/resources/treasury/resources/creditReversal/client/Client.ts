...
export class CreditReversal {
    constructor(protected readonly _options: CreditReversal.Options) {}

    /**
     * <p>Returns a list of CreditReversals.</p>
     *
     * @param {Stripe.treasury.CreditReversalListRequest} request
     * @param {CreditReversal.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async list(
    ...
    ): Promise<Stripe.treasury.CreditReversalListResponse> {
        const {
        ...
        if (receivedCredit != null) {
            _queryParams["received_credit"] = receivedCredit;
        }
        ...
        if (_response.ok) {
            return _response.body as Stripe.treasury.CreditReversalListResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError("Timeout exceeded when calling GET /v1/treasury/credit_reversals.");
            case "unknown":
                throw new errors.StripeError({
     ...
     *
     * @param {Stripe.treasury.CreditReversalCreateRequest} request
     * @param {CreditReversal.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async create(
        ...
        requestOptions?: CreditReversal.RequestOptions,
    ): Promise<Stripe.TreasuryCreditReversal> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return _response.body as Stripe.TreasuryCreditReversal;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling POST /v1/treasury/credit_reversals.",
                );
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {string} creditReversal
     * @param {Stripe.treasury.CreditReversalRetrieveRequest} request
     * @param {CreditReversal.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
    ...
    public async retrieve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.StripeEnvironment.Default,
                `v1/treasury/credit_reversals/${encodeURIComponent(creditReversal)}`,
            ),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.StripeTimeoutError(
                    "Timeout exceeded when calling GET /v1/treasury/credit_reversals/{credit_reversal}.",
                );
            case "unknown":
                throw new errors.StripeError({
                    message: _response.error.errorMessage,
