 ...
 *     {}
 */
export interface SetupIntentUpdateRequest {
    /**
     ...
     */
    flow_directions?: SetupIntentUpdateRequest.FlowDirections.Item[];
    /** Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`. */
    metadata?: SetupIntentUpdateRequest.Metadata;
     ...
     */
    payment_method_data?: SetupIntentUpdateRequest.PaymentMethodData;
    /** Payment method-specific configuration for this SetupIntent. */
    payment_method_options?: SetupIntentUpdateRequest.PaymentMethodOptions;
    /** The list of payment method types (for example, card) that this SetupIntent can set up. If you don't provide this, Stripe will dynamically show relevant payment methods from your [payment method settings](https://dashboard.stripe.com/settings/payment_methods). */
    payment_method_types?: string[];
}

export namespace SetupIntentUpdateRequest {
